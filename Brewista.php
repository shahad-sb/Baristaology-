...
<div class="Product_page">
  ...
  <p class="Product_page_name">Brewista Kettle Second Edition 1.2 Liter Black</p> 
  <br><br>   
  
  <img src="photos/t2.png" width="300" height="270" class="Phone_page_img">
  ...
  <p class="Product_page_price"> 150 SR</p>    
...
<Br>
  <dt>Built-in countdown/countdown timer</dt>
  <hr>
  <dt>Gooseneck spout for precise pouring control</dt>  
  <hr>
  <dt>Precise digital temperature selection in 1-degree increments, common temperature presets</dt>
  <hr>
  <dt>The current and desired temperature is displayed simultaneously on the LCD screen</dt>
  <hr>
  <dt>Rating : 4/5 </dt>
...
<br>
 ...
 <div class="comments">
  <p> <strong><img src="photos/pp1.png" height="20px" width="20px">  sera:</strong></p>
  <p >i love it </p>
